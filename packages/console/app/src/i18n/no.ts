...
export const dict = {
  ...
  "home.faq.a1": "OpenCode is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface or IDE extension.",,
