...
import PROMPT_GENERATE_EN from "./generate.txt"
import PROMPT_EXPLORE_EN from "./prompt/explore.txt"
import PROMPT_DREAM_EN from "./prompt/dream.txt"
import PROMPT_DISTILL_EN from "./prompt/distill.txt"
import PROMPT_SUMMARY_EN from "./prompt/summary.txt"
import PROMPT_COMPACTION_EN from "./prompt/compaction.txt"
import PROMPT_TITLE_EN from "./prompt/title.txt"
import PROMPT_GENERATE_ZH from "./generate-zh.txt"
import PROMPT_EXPLORE_ZH from "./prompt/explore-zh.txt"
import PROMPT_DREAM_ZH from "./prompt/dream-zh.txt"
import PROMPT_DISTILL_ZH from "./prompt/distill-zh.txt"
import PROMPT_SUMMARY_ZH from "./prompt/summary-zh.txt"
import PROMPT_COMPACTION_ZH from "./prompt/compaction-zh.txt"
import PROMPT_TITLE_ZH from "./prompt/title-zh.txt"
import { isChinese } from "../util/prompt-locale"

const PROMPT_GENERATE = isChinese ? PROMPT_GENERATE_ZH : PROMPT_GENERATE_EN
const PROMPT_EXPLORE = isChinese ? PROMPT_EXPLORE_ZH : PROMPT_EXPLORE_EN
const PROMPT_DREAM = isChinese ? PROMPT_DREAM_ZH : PROMPT_DREAM_EN
const PROMPT_DISTILL = isChinese ? PROMPT_DISTILL_ZH : PROMPT_DISTILL_EN
const PROMPT_SUMMARY = isChinese ? PROMPT_SUMMARY_ZH : PROMPT_SUMMARY_EN
const PROMPT_COMPACTION = isChinese ? PROMPT_COMPACTION_ZH : PROMPT_COMPACTION_EN
const PROMPT_TITLE = isChinese ? PROMPT_TITLE_ZH : PROMPT_TITLE_EN
