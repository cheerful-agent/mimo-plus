...
import { EmptyBorder, RoundedBorder, SplitBorder } from "@tui/component/border"
  ...
  return (
    <>
      ...
      <box ref={(r) => (anchor = r)} visible={props.visible !== false}>
        ...
        <box flexDirection="row" paddingLeft={2} paddingRight={2} paddingTop={0} paddingBottom={0} gap={1} justifyContent="space-between">
              ...
              <box flexShrink={0} flexDirection="row" gap={1}>
                <box marginLeft={1}>
                  <Show when={kv.get("animations_enabled", true)} fallback={<text fg={theme.textMuted}>[⋯]</text>}>
                    <spinner color={spinnerDef().color} frames={spinnerDef().frames} interval={200} />
                  </Show>
                </box>
                {(() => {
