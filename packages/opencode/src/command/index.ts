...
import PROMPT_INITIALIZE_EN from "./template/initialize.txt"
import PROMPT_REVIEW_EN from "./template/review.txt"
import PROMPT_INITIALIZE_ZH from "./template/initialize-zh.txt"
import PROMPT_REVIEW_ZH from "./template/review-zh.txt"
import { isChinese } from "../util/prompt-locale"

const PROMPT_INITIALIZE = isChinese ? PROMPT_INITIALIZE_ZH : PROMPT_INITIALIZE_EN
const PROMPT_REVIEW = isChinese ? PROMPT_REVIEW_ZH : PROMPT_REVIEW_EN
