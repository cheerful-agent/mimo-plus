...
import PROMPT_CHECKPOINT_WRITER_EN from "@/agent/prompt/checkpoint-writer.txt"
import PROMPT_CHECKPOINT_WRITER_ZH from "@/agent/prompt/checkpoint-writer-zh.txt"
import { isChinese } from "@/util/prompt-locale"

const PROMPT_CHECKPOINT_WRITER = isChinese ? PROMPT_CHECKPOINT_WRITER_ZH : PROMPT_CHECKPOINT_WRITER_EN
