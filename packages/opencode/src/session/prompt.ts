...
import BUILD_SWITCH_EN from "../session/prompt/build-switch.txt"
import MAX_STEPS_EN from "../session/prompt/max-steps.txt"
import PROMPT_COMPOSE_EN from "../session/prompt/compose.txt"
import BUILD_SWITCH_ZH from "../session/prompt/build-switch-zh.txt"
import MAX_STEPS_ZH from "../session/prompt/max-steps-zh.txt"
import PROMPT_COMPOSE_ZH from "../session/prompt/compose-zh.txt"
import { isChinese } from "../util/prompt-locale"

const BUILD_SWITCH = isChinese ? BUILD_SWITCH_ZH : BUILD_SWITCH_EN
const MAX_STEPS = isChinese ? MAX_STEPS_ZH : MAX_STEPS_EN
const PROMPT_COMPOSE = isChinese ? PROMPT_COMPOSE_ZH : PROMPT_COMPOSE_EN
