...
import DESCRIPTION_EN from "./actor.txt"
import SHELL_DESCRIPTION_EN from "./actor.shell.txt"
import DESCRIPTION_ZH from "./actor-zh.txt"
import SHELL_DESCRIPTION_ZH from "./actor.shell-zh.txt"
import { isChinese } from "../util/prompt-locale"
const DESCRIPTION = isChinese ? DESCRIPTION_ZH : DESCRIPTION_EN
const SHELL_DESCRIPTION = isChinese ? SHELL_DESCRIPTION_ZH : SHELL_DESCRIPTION_EN
