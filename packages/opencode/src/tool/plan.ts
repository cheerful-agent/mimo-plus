...
import EXIT_DESCRIPTION_EN from "./plan-exit.txt"
import EXIT_DESCRIPTION_ZH from "./plan-exit-zh.txt"
import { isChinese } from "../util/prompt-locale"
const EXIT_DESCRIPTION = isChinese ? EXIT_DESCRIPTION_ZH : EXIT_DESCRIPTION_EN
